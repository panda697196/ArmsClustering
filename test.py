...
# 定义文件夹路径
folder_path = 'C:/Users/YUXUAN TENG/Downloads/MotinBVH_Parts/'
...
# 创建一个DBSCAN聚类器对象
dbscan = DBSCAN(eps=0.65, min_samples=1)  # 可根据实际情况调整eps和min_samples参数
